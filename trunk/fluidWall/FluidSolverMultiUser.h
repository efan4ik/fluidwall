...
public:
	 ...
	 *
	 * @param userNo  User ID.
	 * @param x		  X-coordinate, valid values: 1 - N
	 * @param y		  y-coordinate, valid values: 1 - N
	 * @return		  Density value at coordinate.
	 */
	float getDensityAt(int userNo, int x, int y);
